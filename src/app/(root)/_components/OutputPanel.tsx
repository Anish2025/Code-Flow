...
//   // Determine if there's content to copy
...
//             hasContent ? "text-gray-400 hover:text-gray-300" : "text-gray-600 cursor-not-allowed"
//           } bg-[#1e1e2e] rounded-lg ring-1 ring-gray-800/50 hover:ring-gray-700/50
...
//           ) : error ? (
//             <div className="flex items-start gap-3 text-red-400">
//               <AlertTriangle className="w-5 h-5 flex-shrink-0 mt-1" aria-hidden="true" />
//               <div className="space-y-1">
//                 <div className="font-medium">Execution Error</div>
//                 <pre className="whitespace-pre-wrap text-red-400/80">{error}</pre>
//               </div>
